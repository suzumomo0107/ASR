...
from Models.decoder_acoustic import Decoder, LSTMDecoder, TransducerDecoder, DiffDecoder
    ...
    def decode(self, src, src_dummy, beam_width=10, model_lm=None, init_tok=2, eos_tok=1, lm_weight=0.2, model_lm_2=None, lm_weight_2=0.2):
        with torch.no_grad():
            ...
            if self.decoder_type.lower() == 'transformer':
                ...
                results, acoustic = self.decoder.decode_v3(e_output, src_mask, model_lm, lm_weight, model_lm_2, lm_weight_2, beam_width)
